  ...
  return (
    ...
    style={{
      ...
      <div className="flex lg:flex-row flex-col max-w-7xl mx-auto gap-7 lg:gap-10 items-center justify-center text-center lg:text-center lg:items-center">
        <div className="h-[450px] w-[500px] p-10 bg-white flex items-center justify-center flex-col">
          ...
          <Link href="/chi-siamo#la-squadra">
            <div className="text-[#008DAA] text-md border border-[#008DAA] rounded-full px-8 py-4 mt-10 hover:text-[#FFFFFF] hover:bg-[#008DAA] transition-all duration-300">
              leggi
            </div>
          </Link>
        </div>
